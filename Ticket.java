...
public class Ticket {
    ...
    private static int SP_Ticket = 1;
    ...
    public Ticket(String desc, String p, String rep, Date date) {
        this.description = desc;
        this.priority = p;
        this.reporter = rep;
        this.dateReported = date;
        this.ticketID =  SP_Ticket + ticketIdCounter;
        ticketIdCounter++;
    }

    public static void setSP_Ticket(int SP_Ticket) {
        Ticket.SP_Ticket = SP_Ticket;
    }
